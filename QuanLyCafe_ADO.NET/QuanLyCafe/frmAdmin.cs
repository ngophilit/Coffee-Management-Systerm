...
namespace QuanLyCafe
{
    ...
    {   
        ...
        private void btnBillview_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = dbB.ThongKeBill(DateFrom, DateTo, ref err);
            dt = ds.Tables[0];
